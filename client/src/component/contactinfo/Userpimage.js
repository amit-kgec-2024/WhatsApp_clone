...
const Userpimage = ({ onClick, userId, theme }) => {
  // User Details........................
  ...
  return (
    <div className="profile-animation bg-dark6 z-50 bg-opacity-90 w-full h-screen">
      <div className={`${theme === "#000000" ? "bg-dark6" : "bg-slate-100"} opacity-100 px-6 py-3 flex flex-row justify-between items-center`}>

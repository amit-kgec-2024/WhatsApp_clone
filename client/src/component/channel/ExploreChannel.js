    ...
    <div>
      ...
      <div className="flex flex-row gap-2 px-3 py-3 user-top-bottom-border">
        <button
          ...
          className={`px-4 py-1 bg-dark3 rounded-full ${
            activeButton === "explore" ? "bg-teal-300 text-whitmix2" : ""
          }`}
        >
          Explore
        </button>
        <button
          ...
          className={`px-4 py-1 bg-dark3 rounded-full ${
            activeButton === "mostactive" ? "bg-teal-300 text-whitmix2" : ""
          }`}
        >
          Most active
        </button>
        <button
          ...
          className={`px-4 py-1 bg-dark3 rounded-full ${
            activeButton === "popular" ? "bg-teal-300 text-whitmix2" : ""
          }`}
        >
          Popular
        </button>
        <button
          ...
          className={`px-4 py-1 bg-dark3 rounded-full ${
            activeButton === "new" ? "bg-teal-300 text-whitmix2" : ""
          }`}
        >
          New
        </button>
      ...
      <div className="scrollbaruser overflow-x-scroll">
        {activeButton === "explore" && <LoaderCard />}
        {activeButton === "mostactive" && <LoaderCard />}
        {activeButton === "popular" && <LoaderCard />}
        {activeButton === "new" && <LoaderCard />}
      </div>
    </div>
  );
};

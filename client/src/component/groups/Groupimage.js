...
const Groupimage = ({ onClick, groupId, theme }) => {
  ...
  return (
    <div className="profile-animation bg-dark6 z-50 bg-opacity-90 w-full h-screen">
      <div className={`${theme === "#000000" ? "bg-dark6" : "bg-slate-200"} opacity-100 px-6 py-3 flex flex-row justify-between items-center`}>
        <div className="flex flex-row items-center gap-6">
          <div
            className="w-12 h-12 rounded-full overflow-hidden"
            style={{
              backgroundImage: `url(${groupDetails?.groupimage || defauGroupImage})`,
